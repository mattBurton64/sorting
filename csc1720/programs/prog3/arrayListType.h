   ...
   public:
      ...
      */
      virtual int seqSearch(T searchItem) const = 0;
		...
		/* getAt Function to return data from an index
			precondition: a list wiht data exists, and the
								index is within the range
			postcondition: returns the value at an index
								or -1 if location is out of range
		*/
