...
Classes for managing linked lists of NodeType connections.
*/
...
class linkedListType
{
   ...
   public:
      ...
      //               set to NULL.
		...
		//Function to delete the node containing the largest number
		//in the list.
		//Postcondition: The node containing the largest number
		//					  is deleted and count is decreased by 1.
		//					  Last is updated to point at the new
		//					  last node.

		void forwardPrint();
		//Function to call the recursivePrint() method
		//Precondition: the calling list has data in it

		void reversePrint();
		//Function to call the reverseRecursivePrint() method
		//Precondition: the calling list has data in it
   ...
   private:
      ...
      //               assigned to this list.
		...
		void listKiller();
		//Function to deallocate the memory of a linked list
		//Postcondition: First and last = nullptr and count = 0

		void recursivePrint(nodeType<Type> *cur);
		//Function to print a list recurisively
		//Postcondition: The list contents are output to the terminal

		void recursiveReversePrint(nodeType<Type> *cur);
		//Function to prinnt the list recursively in reverse order
		//Postcondition: The list contents are outputt to the 
		//					  terminal in reverse order
};
...
template <class Type>
void linkedListType<Type>::forwardPrint()
{
	recursivePrint(first);
}

template <class Type>
void linkedListType<Type>::recursivePrint(nodeType<Type> *cur)
{
	if (cur != nullptr)
	{
	   cout << cur->info << " ";
...
template <class Type>
void linkedListType<Type>::recursiveReversePrint(nodeType<Type> *cur)
{
	if (cur)
	{
		recursiveReversePrint(cur->link);
		cout << cur->info << " ";
	}
}
#endif
