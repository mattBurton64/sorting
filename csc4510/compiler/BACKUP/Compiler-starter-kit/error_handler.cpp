...
// Array of error messages is initialized. This allows the language of the error messages to be changed easily.
{
	...
	error_message[103] = "Boolean expression expected."; //  first occurance
	...
	error_message[117] = "Boolean expression expected.";  // second occurance
	error_message[118] = "Integer or real expression expected.";
	error_message[119] = "Integer expression expected.";
	error_message[120] = "Boolean expression expected."; // third occurance
	...
	error_message[124] = "Empty strings are not permitted.";
	error_message[125] = "An addition operator is expected.";
	error_message[126] = "A multiplication operator is expected.";
	error_message[127] = "A number is expected";
