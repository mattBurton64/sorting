// This program is intended to investigate the properties of passing by value in C++
#include <iostream>
using namespace std;

int subInt(int integer) // declaring a subroutine which takes in an integer parameter by value
{
    integer = 0; // alter the value
    return integer;
}

float subFloat(float floating) // declaring a subroutine which takes in a float parameter by value
{
    floating = 0.0; // alter the value
    return floating;
}

bool subBool(bool boolean) // declaring a subroutine which takes in a boolean parameter by value
{
    boolean = false; // alter the value
    return boolean;
}

char subChar(char character) // declaring a subroutine which takes in a char parameter by value
{
